...
def abc():
    ...
    def price():
        ...
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="_",
                        fg="white", anchor=W)
        ...
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="icecream",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=1, column=0)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="25",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=1, column=3)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Aloo Paratha",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=2, column=0)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="25",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=2, column=3)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Poha",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=3, column=0)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="20",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=3, column=3)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Upama",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=4, column=0)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="35",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=4, column=3)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="vadapav",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=5, column=0)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="10",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=5, column=3)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text=" Special Thali",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=6, column=0)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="70",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=6, column=3)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="10",
                        fg="#ED420B", anchor=W)
        lblinfo.grid(row=7, column=3)
        lblinfo = Label(roo, font=('aria', 15, 'bold'), text="Coffee",
                        fg="#ED420B", anchor=W)
    ...
    def onsubmit():
       ...
       for i in range(1,9):
            ...
            Quantitylist= [dringE.get(),AlooparathaE.get(),Poha.get(),upama.get(),vadapav.get(),Thali.get(),Coffee.get(),tea.get()]
            ...
            nettotal = Label(frame4,text=f"Net Total {subtotal}\n\n\n Sir Please Pay ₹{subtotal}\n\n\n Thank you for Visiting\n\nVist again!!!", font="arial 12 bold",bg="#96C3EB",fg="blue")
            nettotal.place(x=525,y=220)

    def save_bill():
                import pyautogui
                myScreenshot = pyautogui.screenshot()
                myScreenshot.save(fr'C:\Users\kshit\OneDrive\Documents\Canteen Screenshot\Bill_{stu_naE.get()}_{stu_idE.get()}.png')
    ...
    line_total = Label(frame4, text="",bg="#96C3EB", font="arial 12 bold")
    linet_total = Label(frame4, text="",bg="#96C3EB", font="arial 12 bold")
...
def admin():
    ...
    root_label = Label(admin_frame, text="Password", font="arial 15 bold ", bg="#696969")
    root_label.place(x=45, y=95)
    pass_labelE = Entry(admin_frame, bd=5)
    pass_labelE.place(x=150,y=95)
    def all_nvalid():
        if pass_labelE.get() == "0000" and user_labelE.get() == "VIIT123":
            abc()
        else:
            text1_label = Label(admin_frame, text="Password or Username is Invalid !!!!!", font="arial 15 bold ",bg="#696969")
